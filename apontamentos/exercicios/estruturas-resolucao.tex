...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.9\textwidth]{imgs/estruturas_35-2.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.8\textwidth]{imgs/estruturas_41.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.8\textwidth]{imgs/estruturas_45-2.png}}
