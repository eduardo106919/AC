...
int main() {
    ...
    GraphM gm1 = {
        {NE, 2, NE, NE, NE, 7, 3, NE, NE}, {2, NE, 4, NE, NE, NE, 6, NE, NE},
        {NE, 4, NE, 2, NE, NE, NE, 2, NE}, {NE, NE, 2, NE, 1, NE, NE, 8, NE},
        {NE, NE, NE, 1, NE, 6, NE, NE, 2}, {7, NE, NE, NE, 6, NE, NE, NE, 5},
        {3, 6, NE, NE, NE, NE, NE, 3, 1},  {NE, NE, 2, 8, NE, NE, 3, NE, 4},
    ...
    printf("\n");
    for (int i = 0; i < n1; i++)
        printf("Graus do vértice %d: entrada %d, saída %d\n", i,
               inDegree(gl1, i, n1), outDegree(gl1, i));
